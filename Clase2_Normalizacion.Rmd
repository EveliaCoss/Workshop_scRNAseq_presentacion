...
- **Detección de multipletes/dobletes**
   + Herramientas como `[DoubletFinder](https://www.sciencedirect.com/science/article/pii/S2405471219300730) o Scrublet` ayudan a identificar células que en realidad son mezclas de dos.
...
`r fontawesome::fa("laptop-file", height = "3em")`
# Control de calidad de los datos con `Seurat`
...
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("figures/qc2-1.png")
```
]

.footnote-right[Imagen tomada de: [Seurat - Guided Clustering Tutorial](https://satijalab.org/seurat/articles/pbmc3k_tutorial)
]
...
.pull-left[
## ¿Qué muestra un **UMAP** en scRNA-seq?
Algoritmo de **reducción de dimensionalidad** que transforma datos de alta dimensión en representaciones de pocas dimensiones (2D o 3D), preservando tanto las relaciones locales como globales. 

- **Tipo de algoritmo:** aprendizaje no supervisado.
- **Objetivo:** reducir dimensiones manteniendo la estructura de los datos.
- **Método:** construye un grafo que representa relaciones entre puntos y luego proyecta esos datos en un espacio de menor dimensión.
]
...
.pull-left[
## ✅ Ventajas
- 🔬 **Cantidad mínima de material:** permite estudiar células individuales con muy poco RNA, revelando **heterogeneidad** que bulk RNA-seq oculta.
- **⚡ Eficiencia de captura variable:** aunque genera *dropouts*, esta variabilidad también puede reflejar diferencias reales entre células.
]

.pull-right[
## ❌ Desventajas
- 🔬 **Cantidad mínima de material:** aumenta la probabilidad de pérdidas y errores durante captura y amplificación.
- **⚡ Eficiencia de captura variable:** genera *dropouts*, dificultando distinguir entre ausencia real de expresión y fallos técnicos.
]


---

- **⚡ Eficiencia de captura variable:** no todas las moléculas de RNA presentes en la célula se detectan; esto genera “dropouts” (genes que parecen no expresarse aunque sí lo estén).

- 🧪 **Amplificación por PCR:** necesaria para obtener suficiente material, pero introduce sesgos y variabilidad entre células.

- 📊 **Ruido estocástico:** pequeñas diferencias técnicas se amplifican y pueden confundirse con diferencias biológicas.

- 🧩 ***Batch effects:*** diferencias entre corridas de secuenciación, reactivos o equipos que afectan la comparabilidad.

- 🧠 **Procesamiento computacional:** la normalización y corrección de datos es compleja; decisiones en el pipeline pueden introducir artefactos.
