...
-   **Número de acceso de la base de datos GEO (Gene Expression Omnibus):**
...
[![Información suplementaria encontrada en GEO para el **GSE149689.**](images/clipboard-1556849944.png){#fig-data}](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE149689)
...
## Paso 7. Filtrado de células con baja calidad
